...
INSERT INTO `applydata` (`apply_ID`, `file_ID`, `apply_status`, `apply_a_u_ID`, `apply_b_u_ID`, `apply_created_d`, `approved_d`, `apply_other`, `apply_url`) VALUES
(1, 3, 1, 's', '0', '2025-10-07 09:46:40', NULL, '', 'uploads/images/img_68e471008d7fa.jpg'),
(2, 5, 1, 's', '0', '2025-10-07 10:12:53', NULL, 's', 'uploads/images/img_68e47725cdff4.jpg'),
(3, 5, 1, '饒凱婷', '0', '2025-10-07 14:35:51', NULL, '', 'uploads/images/img_68e4b4c7f0b54.jpg'),
(4, 5, 1, '饒凱婷', '0', '2025-10-07 14:39:43', NULL, '', 'uploads/images/img_68e4b5afa02c6.jpg'),
(5, 4, 1, 's', '0', '2025-10-07 14:47:06', NULL, '', 'uploads/images/img_68e4b76a87512.jpg');
...
(1, '1', 'templates/tpl_20250915_094925_807a8b.pdf', NULL, 0, '2025-10-02 13:58:21', 1, NULL),
(2, '2', 'templates/tpl_20250915_094931_512ef3.pdf', NULL, 0, '2025-10-02 13:58:27', 1, NULL),
(3, '3', 'templates/tpl_20250915_094936_f7d037.pdf', NULL, 0, '2025-10-02 12:37:54', 1, NULL),
(4, '4', 'templates/tpl_20250917_084809_75af77.pdf', NULL, 0, '2025-10-02 13:50:44', 1, NULL),
(5, 's', 'templates/tpl_20250917_165018_966166.pdf', NULL, 0, '2025-10-02 13:58:15', 1, NULL);
...
CREATE TABLE `reviewperiods` (
  `period_ID` int(11) NOT NULL COMMENT '互評時段ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='互評時段設定資料';

--
-- 傾印資料表的資料 `reviewperiods`
--

INSERT INTO `reviewperiods` (`period_ID`, `period_start_d`, `period_end_d`, `period_title`, `is_active`, `period_created_d`) VALUES
...
(6, '學生', '學生', '2025-07-17 03:52:46', '2025-07-17 03:52:46', 1);
...
(2, '110534213', '2025-07-17 04:51:52', 1),
...
--
ALTER TABLE `applydata`
  MODIFY `apply_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '申請ID', AUTO_INCREMENT=6;
...
--
ALTER TABLE `filedata`
  MODIFY `file_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '文件ID', AUTO_INCREMENT=6;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `reviewperiods`
--
ALTER TABLE `reviewperiods`
  MODIFY `period_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '互評時段ID', AUTO_INCREMENT=6;

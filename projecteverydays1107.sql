...
CREATE TABLE `cohortdata` (
  ...
  `cohort_start_d` date DEFAULT NULL COMMENT '該屆開始時間',
  `cohort_end_d` date DEFAULT NULL COMMENT '該屆起始時間',
...
CREATE TABLE `pereviewdata` (
  ...
  `petarget_ID` int(11) NOT NULL COMMENT '目標對象ID',
  `pe_u_ID` varchar(25) NOT NULL COMMENT '評分者',
  `score` int(11) DEFAULT NULL COMMENT '星星數',
  `peer_comment` text DEFAULT NULL COMMENT '評論',
  `peer_created_d` datetime DEFAULT NULL COMMENT '評分時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='互評紀錄';
...
CREATE TABLE `perioddata` (
  ...
  `pe_target_ID` int(11) DEFAULT NULL COMMENT '留空則為全部人',
  `cohort_ID` int(11) DEFAULT NULL COMMENT '屆',
  `pe_created_d` datetime DEFAULT NULL COMMENT '建立時間',
  `pe_created_u_ID` varchar(25) DEFAULT NULL COMMENT '建立者',
  `pe_role_ID` int(11) NOT NULL COMMENT '當下角色',
  `pe_status` int(11) NOT NULL COMMENT '狀態'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='評分';
...
CREATE TABLE `petargetdata` (
  ...
  `petar_class_ID` int(11) DEFAULT NULL COMMENT '班級',
  `petar_team_ID` int(11) DEFAULT NULL COMMENT '團隊',
  `petar_u_ID` varchar(25) DEFAULT NULL COMMENT '使用者'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='評分目標';
...
CREATE TABLE `requirementdata` (
  ...
  `req_start_d` date DEFAULT NULL COMMENT '起始日',
  `req_end_d` date DEFAULT NULL COMMENT '截止日',
...
CREATE TABLE `taskdata` (
  ...
  `task_created_u_ID` varchar(25) DEFAULT NULL COMMENT '建立人',
...
INSERT INTO `teamdata` (`team_ID`, `group_ID`, `team_project_name`, `cohort_ID`, `team_status`, `team_update_d`) VALUES
(1, 1, '專題管理', 3, 1, '2025-11-06 12:14:02'),
(2, 1, '微旅日記', 3, 1, '2025-11-06 12:14:02'),
(3, 1, '莫德經絡', 2, 0, '2025-11-06 12:14:02'),
...
INSERT INTO `teammember` (`team_ID`, `team_u_ID`, `tm_status`, `tm_updated_d`) VALUES
(1, '110534205', 1, '2025-11-06 12:17:00'),
(1, '110534215', 1, '2025-11-06 12:17:00'),
(1, '110534221', 1, '2025-11-06 12:17:00'),
(1, '110534231', 1, '2025-11-06 12:17:00'),
(1, 'tengteng', 1, '2025-11-06 12:17:00'),
(2, '110534207', 1, '2025-11-06 12:17:00'),
(2, '110534216', 1, '2025-11-06 12:17:00'),
(2, '110534217', 1, '2025-11-06 12:17:00'),
(2, 'toshiko', 1, '2025-11-06 12:17:00'),
(3, '109534201', 1, '2025-11-06 12:17:00'),
(3, '109534206', 1, '2025-11-06 12:17:00'),
(3, '109534207', 1, '2025-11-06 12:17:00'),
(3, 'tengteng', 1, '2025-11-06 12:17:00'),
(4, '110511114', 1, '2025-11-06 12:17:00'),
(4, '110534201', 1, '2025-11-06 12:17:00'),
(4, '110534225', 1, '2025-11-06 12:17:00'),
(4, '110534236', 1, '2025-11-06 12:17:00'),
(4, 'tengteng', 1, '2025-11-06 12:17:00'),
(5, '110534101', 1, '2025-11-06 12:17:00'),
(5, '110534102', 1, '2025-11-06 12:17:00'),
(5, '110534202', 1, '2025-11-06 12:17:00'),
(5, '110534213', 1, '2025-11-06 12:17:00');
...
('109534201', '109534201', '林恩宇', '109534201@stu.ukn.edu.tw', '我站在雲林', 'u_img_109534201_1760580532.jpg', 0, '2025-11-06 11:28:35'),
('109534206', '109534206', '蓁蓁咪', '109534206@stu.ukn.edu.tw', '早上沒事，晚上台中市', 'u_img_109534206_1755065596.png', 0, '2025-11-06 11:28:35'),
('109534207', '109534207', '書桑', '109534207@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
...
('110534202', '110534202', '逢尼', '110534202@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
...
('110534207', '110534207', '沁桑', '110534207@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
...
('110534215', '110534215', '莉桑', '110534215@stu.ukn.edu.tw', '嗨莉莉莉', NULL, 1, '2025-11-06 11:28:35'),
...
('110534235', '110534235', '加一', '110534235@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534236', '110534236', '二廷', '110534236@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534242', '110534242', '宏陳', '110534242@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
...
ALTER TABLE `pereviewdata`
  ...
  ADD KEY `fk_prv_target` (`petarget_ID`),
  ADD KEY `fk_prv_user` (`pe_u_ID`),
...
ALTER TABLE `perioddata`
  ...
  ADD KEY `fk_pe_cohort` (`cohort_ID`),
  ADD KEY `fk_pe_user` (`pe_created_u_ID`),
  ADD KEY `fk_pe_role` (`pe_role_ID`),
  ADD KEY `fk_pe_status` (`pe_status`);
...
ALTER TABLE `petargetdata`
  ...
  ADD KEY `fk_pet_class` (`petar_class_ID`),
  ADD KEY `fk_pet_team` (`petar_team_ID`),
  ADD KEY `fk_pet_user` (`petar_u_ID`);
...
ALTER TABLE `taskdata`
  ...
  ADD KEY `fk_task_user3` (`task_created_u_ID`),
...
ALTER TABLE `timedata`
  ...
  ADD KEY `idx_timedata_start` (`time_start_d`),
...
--
ALTER TABLE `enrollmentdata`
  MODIFY `enroll_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `typedata`
  MODIFY `type_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '主鍵';
...
ALTER TABLE `pereviewdata`
  ...
  ADD CONSTRAINT `fk_prv_target` FOREIGN KEY (`petarget_ID`) REFERENCES `petargetdata` (`pe_target_ID`),
...
--
ALTER TABLE `perioddata`
  ADD CONSTRAINT `fk_pe_cohort` FOREIGN KEY (`cohort_ID`) REFERENCES `cohortdata` (`cohort_ID`),
  ADD CONSTRAINT `fk_pe_role` FOREIGN KEY (`pe_role_ID`) REFERENCES `roledata` (`role_ID`),
  ADD CONSTRAINT `fk_pe_status` FOREIGN KEY (`pe_status`) REFERENCES `statusdata` (`status_ID`),
...
--
ALTER TABLE `petargetdata`
  ADD CONSTRAINT `fk_pet_class` FOREIGN KEY (`petar_class_ID`) REFERENCES `classdata` (`c_ID`),
  ADD CONSTRAINT `fk_pet_team` FOREIGN KEY (`petar_team_ID`) REFERENCES `teamdata` (`team_ID`),
  ADD CONSTRAINT `fk_pet_user` FOREIGN KEY (`petar_u_ID`) REFERENCES `userdata` (`u_ID`);
...
ALTER TABLE `taskdata`
  ...
  ADD CONSTRAINT `fk_task_user3` FOREIGN KEY (`task_created_u_ID`) REFERENCES `userdata` (`u_ID`);
